...
import (
	...
	lowlevel "github.com/OneKeyHQ/onekey-bridge/usb/lowlevel/libusb"
...
If you run onekey in an environment without USB (for example, docker or travis), use '-u=false'. For example, './onekey-go -e 21324 -u=false'.
